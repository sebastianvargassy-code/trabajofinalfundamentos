...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', sans-serif; }
        ...
        .btn-vaciar { display: block; text-align: center; background-color: #BAB5AD; color: white; text-decoration: none; padding: 30px; border-radius: 6px; font-size: 13px; margin-top: 15px; font-weight: bold; }
